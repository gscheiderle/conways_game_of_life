...
?>
	...
	<table>
		...
		<tr>
			...
			<td>&nbsp;</td>
			<td> <button name="ausfuehren" value="ausfuehren" style=" width: 250px; height: 40px; font-color: #000000; font-size: 22px; background-color: #00cc00; border-radius: 5px 5px 5px 5px;">Ausf&uuml;hren</button>
			</td>
		</tr>
...
mysqli_query($link," insert into table_game_3 (id, generation) values ( '$aktuelles_feld', '$generation') ");
echo mysqli_error();
} // ende if
...
echo "<br>";
/* Zaehler bis zum Zeilenumbruch */
$zaehler_raster=1;

/* haendisch definierter Zeilenumbruch */
$neue_zeile=$_POST['zeilenumbruch'];


// echo "<br>".$i; // Nummerierung der Generationen

/* Beginn visuelle Ausgabe der Generation(en) mittels Web-Browser */
echo "<table border='1' width='600px' height='200px' bgcolor='#FFFFFF'>
<tr>";

$raster=mysqli_query($link," select id, farbe from $table_game ");
while ( $result_raster = mysqli_fetch_array( $raster , MYSQLI_BOTH ) ) {

/* zaehlen bis zum Zeilenumbruch  */
if ( $zaehler_raster == $neue_zeile ) { 
$tr="</tr><tr>"; $zaehler_raster=0; 
}

/* Farbwechsel der aktuellen Zelle festlegen (oder kein Wechsel) */
$color="#000000";
if ( $result_raster['farbe'] == 1 ) { 
$color="green"; 
}

/* Gestaltung */
echo "<td align='right' bgcolor='$color' width='18px' height='5px'>&nbsp;</td>".$tr;
$tr="";
$zaehler_raster++;
